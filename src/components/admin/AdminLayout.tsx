...
import { Loader2, Users, ClipboardCheck, CreditCard, LogOut, LayoutDashboard, FileText, Building } from "lucide-react";
...
const menuItems = [
  ...
  { title: "Aberturas", url: "/admin/formations", icon: Building },
